...
export const DECOR_ASSETS: DecorAsset[] = [
  {
    ...
    applicability: { semantics: ['自然', '植物', '生长'] },
    exclusions: {
      styles: ['tech', 'academic', 'minimal'],
      reasons: '花草有机母题与理性/科技风格冲突（tech/academic 风格卡明令禁用 leaf）',
    },
  ...
  },
  {
    ...
    applicability: { semantics: ['自然', '植物'] },
    exclusions: { styles: ['tech', 'academic', 'minimal', 'china'], reasons: '花草有机母题，国风/理性/科技风格不使用' },
  ...
  },
  {
    ...
    applicability: { semantics: ['自然', '植物'] },
    exclusions: { styles: ['tech', 'academic', 'minimal'], reasons: '具象自然物，理性/科技风格不使用' },
    styleAffinity: ['forest', 'nature'],
    placement: ['corner', 'edge'],
  ...
  },
  {
    ...
    applicability: { semantics: ['自然', '植物', '美好'] },
    exclusions: {
      styles: ['tech', 'academic', 'minimal'],
      subjects: ['数学', '物理', '化学', '信息技术'],
      reasons: '高饱和花卉与理性学科/风格冲突（多张风格卡禁用 flower）',
    },
  ...
  },
  {
    ...
    applicability: { semantics: ['自然', '植物', '季节'] },
    exclusions: { styles: ['tech', 'academic', 'minimal'], reasons: '具象自然物，理性/科技风格不使用' },
    styleAffinity: ['forest', 'nature'],
  ...
  },
  {
    ...
    applicability: { semantics: ['自然', '天气', '温暖'] },
    exclusions: { styles: ['minimal'], reasons: '极简风格不挂具象装饰（装饰强度最低）' },
    styleAffinity: ['forest', 'nature', 'storybook'],
    placement: ['corner'],
  ...
  },
  {
    ...
    applicability: { semantics: ['自然', '生物', '童趣'] },
    exclusions: {
      styles: ['tech', 'academic', 'minimal', 'china'],
      subjects: ['数学', '物理', '化学', '信息技术', '历史', '政治'],
      reasons: '童趣昆虫，理性/国风风格与高学段学科均不适（多张风格卡禁用 ladybug）',
    },
    styleAffinity: ['forest', 'nature'],
    placement: ['corner', 'edge'],
