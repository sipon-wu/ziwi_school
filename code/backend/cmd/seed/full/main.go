	...
	coursewares := []model.Material{
		{
			...
			Content:  "# 《观潮》\n\n<!-- layout: edu-cover -->\n## 《观潮》\n- 人教版四年级上册 第一单元 第1课\n- 钱塘江大潮，被称为“天下奇观”\n\n<!-- layout: edu-goal -->\n## 教学目标\n- 知识与技能：会写“笼罩、横贯、恢复”等生字，有感情地朗读课文\n- 过程与方法：学习按“潮来前—潮来时—潮头过后”的时间顺序描写景物\n- 情感态度：感受钱塘江大潮的壮丽奇观，激发热爱祖国河山之情的情感\n\n<!-- layout: edu-explain -->\n## 知识讲解 · 大潮奇观\n- 概念：天下奇观——钱塘江大潮因天体引力和特殊地形，形成世界著名的涌潮\n- 要点一：潮来前，江面风平浪静，薄雾笼罩，人们昂首东望\n- 要点二：潮来时，白浪翻滚，犹如千万匹白色战马齐头并进，声势浩大\n- 要点三：潮头过后，余波漫天卷地，江水涨了两丈来高\n\n<!-- layout: edu-example -->\n## 例题演练\n- 题干：读“浪潮越来越近，犹如千万匹白色战马齐头并进”，说说这样写的好处\n- 分析：作者运用比喻的修辞手法\n- 解答：把浪潮比作千万匹白色战马，生动写出潮水逼近时气势磅礴、势不可挡的样子\n\n<!-- layout: edu-summary -->\n## 课堂小结\n- 写作顺序：按时间推移，条理清晰地再现大潮全过程\n- 表达特点：动静结合、由远及近、比喻生动\n- 中心思想：赞美自然奇观，抒发对祖国河山的热爱\n\n<!-- layout: edu-homework -->\n## 作业布置\n- 基础：抄写本课生字词各两遍，有感情朗读课文\n- 提高：摘抄文中描写潮水的3个精彩句子并批注\n- 拓展：搜集一首描写江河湖海的古诗词，下节课分享",
		...
		},
		{
			...
			Content:  "# 小数乘法\n\n<!-- layout: edu-cover -->\n## 小数乘法\n- 人教版五年级上册 第一单元\n- 小数乘整数与乘小数\n\n<!-- layout: edu-goal -->\n## 教学目标\n- 知识与技能：理解小数乘整数的算理，掌握计算方法\n- 过程与方法：经历探究过程，能正确进行笔算并验算\n- 情感态度：在解决实际问题中体会数学与生活的联系\n\n<!-- layout: edu-explain -->\n## 知识讲解 · 计算法则\n- 概念：先按整数乘法算出积，再看因数共有几位小数\n- 法则：从积的右边起数出几位，点上小数点\n- 推导：0.72 × 5 = 3.60，因数共两位小数，末尾去0得 3.6\n- 注意：积的小数位数不够时，用 0 补足再点小数点\n\n<!-- layout: edu-example -->\n## 例题演练\n- 题干：计算 2.4 × 0.8\n- 思路：先算 24 × 8 = 192，因数共两位小数\n- 解答：从192右边数两位 → 1.92，即 2.4 × 0.8 = 1.92\n- 验算：1.92 ÷ 0.8 = 2.4，结果正确\n\n<!-- layout: edu-summary -->\n## 课堂小结\n- 步骤口诀：一看（因数小数位）二算（整数乘法）三点（点小数点）\n- 易错：忘记点小数点、位数不够未补0\n- 应用：购物计价、长度面积计算都常用\n\n<!-- layout: edu-homework -->\n## 作业布置\n- 基础：完成练习册第1、2题\n- 提高：计算 0.25 × 0.4 并验算\n- 拓展：思考“积与因数大小关系”的规律",
